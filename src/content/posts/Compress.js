...
export default function Compress() {
    return (
        <div class="blog-post">
            ...
            import Compress from "./posts/Compress";<br />
            const posts = [<br />
                <span class="tab-1" />&#123; <br />
                <span class="tab-2" />title: "Compressing images for faster load times - progressive jpgs are your friend",<br />
                <span class="tab-2" />content: &lt;Compress /&gt;,<br />
                <span class="tab-2" />path: "compressing-images-for-faster-load-times"<br />
                <span class="tab-1" />&#125;,<br />
                <span class="tab-1" />&#123; <br />
                <span class="tab-2" />title: "Keeping multiple images uniform - handy CSS tips",<br />
                <span class="tab-2" />content: [],<br />
                <span class="tab-2" />path: "keeping-multiple-images-uniform"<br />
                <span class="tab-1" />&#125;
            ];
